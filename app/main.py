...
# Application title
st.title("Gerenciamento e Otimização do Consumo Energético")
...
consumption_placeholder = col1.metric("Consumo Atual (kWh)", "Carregando...")
rate_placeholder = col2.metric("Tarifa Atual (R$/kWh)", "Carregando...")
cost_placeholder = col3.metric("Custo Total (R$)", "Carregando...")
